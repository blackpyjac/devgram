    ...
    <div class="container">
        <div class="row">
            <div class="col-3 p-5">
                ...
                <img src="{{ $user->profile->profileImage() }}" alt="" style="height: 160px;" class="rounded-circle">
            </div>
            <div class="col-9 pt-5">
                ...
                <div class="pt-4"><span class="fw-bold">{{ $user->profile->title }}</span> <span
                        class="text-muted">she/her</span>
                </div>
